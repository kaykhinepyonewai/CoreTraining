            ...
            "columns": [
                ...
                { "data": "createdUserName", "name": "CreatedUserName", "autoWidth": true },
                {
                    render: function (data, type, full) {
                        ...
                        actions += "<button type='button' class='btn btn-dark btn-sm btn-lg dropdown-toggle' data-bs-toggle='dropdown' aria-expanded='false'>Action</button>";
...
table.addEventListener('click', (event) => {
    // check if the clicked element has a class of "dropdown-btn"
    if (event.target.classList.contains('btnDropDown')) {
        console.log("Hello");
        // prevent the default behavior of the dropdown button
